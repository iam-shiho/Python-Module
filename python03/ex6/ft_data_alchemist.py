...
def main() -> None:
    ...
    print(f"New list with all names capitalized: {capitalize_name}")
    capitalized = [player for player in PLAYERS if player == player.capitalize()]
    ...
    high_scores = {player: score for player, score in add_score.items() if score > average}
